...
AS $$
  SELECT CASE plan_name
    WHEN 'partner' THEN 1.0 * 0.10  -- 10% de R$ 1,00
    WHEN 'premium' THEN 41.25 * 0.10  -- 10% de R$ 41,25
    WHEN 'master' THEN 6.0 * 0.10     -- 10% de R$ 6,00
    WHEN 'platinum' THEN 100.0 * 0.10 -- 10% de R$ 100,00
    ELSE 0.0
  END;
$$;
