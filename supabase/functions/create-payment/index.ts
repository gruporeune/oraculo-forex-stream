...
serve(async (req) => {
  ...
  try {
    ...
    // SecretPay payload - FORMATO CORRETO SEM MUDANÇAS DA FATUREFY
    const payload = {
      ...
      items: [{
        ...
        value: Math.round(amount * 100), // SecretPay usa "value", não "amount"
        quantity: 1
        // REMOVIDO: tangible - não existe na API da SecretPay
      }]
    }
