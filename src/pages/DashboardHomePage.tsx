...
export default function DashboardHomePage({ user, profile, onProfileUpdate }: DashboardHomePageProps) {
  ...
  return (
    ...
    >
      ...
      {/* Video and Banners Section - Aligned with Cards Above */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        className="mb-8"
      >
        {/* Grid matching the dashboard cards layout */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          
          {/* YouTube Video Section - Spans 2 columns (aligns with "Seus Planos" + "Seus Sinais") */}
          ...
          {/* Banner 1 - Aligns with "Ganho do Dia" */}
          ...
          {/* Banner 2 - Aligns with "Comissões do Dia" */}
          <div className="col-span-1 hidden lg:block">
            <Tilt
              rotationFactor={4}
              isRevese
          ...
          {/* Banner 3 - Aligns with "Saldo Disponível" */}
          <div className="col-span-1 hidden lg:block">
            <Tilt
              rotationFactor={4}
              isRevese
        ...
        {/* Mobile banners - Show as small thumbnails */}
        ...
        <div className="hidden lg:grid lg:grid-cols-5 lg:gap-6">
          ...
          <div className="col-span-1">
            ...
            >
              ...
              >
                ...
                />
                <div className="relative bg-gradient-to-br from-blue-600/80 to-blue-500/80 backdrop-blur-xl border border-blue-400/30 rounded-2xl p-6 hover:border-blue-300/50 transition-all duration-300 cursor-pointer w-full h-[200px] flex flex-col justify-center items-center">
                  <div className="flex items-center justify-center mb-4">
                    <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center">
                      <span className="text-blue-600 font-bold text-xl">EX</span>
                    </div>
                  </div>
                  <div className="space-y-2 text-center">
                    <h4 className="text-lg font-bold text-white">Exnova</h4>
          ...
          {/* WhatsApp Card - Full width like banners */}
          <div className="col-span-1">
            <a 
            ...
            >
              ...
              >
                ...
                />
                <div className="relative bg-gradient-to-br from-green-600/80 to-green-500/80 backdrop-blur-xl border border-green-400/30 rounded-2xl p-6 hover:border-green-300/50 transition-all duration-300 cursor-pointer w-full h-[200px] flex flex-col justify-center items-center">
                  <div className="flex items-center justify-center mb-4">
                    <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center">
