...
export default function DashboardHomePage({ user, profile, onProfileUpdate }: DashboardHomePageProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col lg:flex-row items-start justify-center gap-6 lg:gap-8 max-w-7xl mx-auto px-4">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto">
            ...
            >
              <Spotlight
                className="z-10 from-red-500/50 via-red-500/20 to-red-500/10 blur-3xl"
                size={400}
                springOptions={{
                  stiffness: 26.7,
                  damping: 4.1,
